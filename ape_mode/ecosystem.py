...
class ApeModeError(ApeException):
    """
...
class Mode(Ethereum):
    @property
    def config(self) -> ModeConfig:  # type: ignore
        return cast(ModeConfig, self.config_manager.get_config("mode"))
